    ...
    >
      ...
      >
        ...
        <View className="absolute bottom-0 left-0 w-full h-full p-2 flex flex-col justify-end items-stretch">
          <Text className="font-inter-regular text-white text-lg">{brand.name}</Text>
          <Text className="font-inter-regular text-white text-sm">{brand.category?.name[locale]}</Text>
        </View>
      </TouchableOpacity>
    </Animated.View>
  );
